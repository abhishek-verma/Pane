...
description: "Set up Pane in 2 minutes"
---

Welcome to Pane! Let's get you set up.
...
<Steps>
  ...
  <Step title="Set up your AI">
    Pane includes a default AI model with limited daily usage. For the best experience, add your own.
...
<Tip>
**Block ads with uBlock Origin** — Chrome dropped support for the full uBlock Origin extension, but Pane brought it back. [Install it from the Chrome Web Store](https://chromewebstore.google.com/detail/ublock-origin/cjpalhdlnbpafiamejdnhcphjbkeiagm) and browse ad-free. [Learn more →](/features/ad-blocking)
</Tip>

Explore what Pane can do:
...
<Columns cols={2}>
  ...
  <Card title="Use with Claude Code" icon="terminal" href="/features/use-with-claude-code">
    Control Pane from Claude Code or Gemini CLI
  </Card>
</Columns>
