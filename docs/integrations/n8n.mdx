...
Connect Pane to n8n to build automated workflows. Your n8n AI agents can control the browser—open pages, click buttons, extract data, and fill forms.
...
Before you start:
- Pane running with MCP server enabled (Settings → Pane as MCP)
...
- **Endpoint**: Your Pane MCP URL (find it in Settings → Pane as MCP)
- **Server Transport**: `HTTP Streamable`

<img src="/images/n8n-step5-mcp-client.png" alt="MCP Client configuration with Pane URL" />
...
- Make sure Pane is running
- Check that MCP server is enabled in Pane settings
- Verify the port number matches your Pane MCP URL
