---
title: "Changelog"
description: "What's new in Pane"
---

All notable changes to Pane are documented here. For the full release history with download links, see our [GitHub Releases](https://github.com/browseros-ai/Pane/releases).
...
- **New MCP tools** — A tighter, more reliable browser tool surface for agents, rebuilt from the ground up. Plus one-click install of Pane as an MCP server into the agents you already run, with automatic URL sync.
...
- **ChatGPT Pro & GitHub Copilot** — Already paying for ChatGPT Pro, Plus, or GitHub Copilot? Use that subscription to automate browser tasks in Pane at no extra cost — just log in with your existing account.
...
- **Kimi K2.5** — In partnership with Moonshot AI, Kimi K2.5 is now the default model in Pane — open-source, multimodal, and great for browser automation. Bring your own key from [platform.moonshot.ai](https://platform.moonshot.ai/) anytime.
...
- **Vertical tabs** — One of the most requested features is here. Pane now ships with vertical tabs by default. More screen space, better tab management, and a cleaner layout out of the box. Prefer horizontal? You can switch back anytime in settings. [Read more →](/features/vertical-tabs)
...
<Frame>
  <img src="/images/changelog/0.42.0/soul-memory.png" alt="Pane v0.42.0 SOUL.md feature for agent personalization" />
</Frame>

<Frame>
  <img src="/images/changelog/0.42.0/vertical-tabs.png" alt="Pane v0.42.0 vertical tabs toggle in settings" />
</Frame>
...
<Frame>
  <img src="/images/changelog/0.39.0-sync-mcp.png" alt="Pane v0.39.0 featuring Sync and improved MCP connectors" />
</Frame>
...
- **Gemini 3 support** — Gemini 3 Pro and Flash models now work with Pane
- **Windows icon fix** — The Windows icon now displays Pane logo correctly
...
<Note>
For older releases, see the [full release history on GitHub](https://github.com/browseros-ai/Pane/releases).
</Note>
