...
Pane works great with local models for Chat Mode. Run models completely offline — your data never leaves your machine.

## Context Length

<Warning>
**Ollama defaults to 4,096 tokens of context — this is too low for Pane.** Below 15K tokens, the context overflows and the agent gets stuck in a loop constantly trying to recover. Only Chat Mode will work at low context lengths. Set at least **15,000–20,000 tokens** for local models to function properly.
</Warning>
  ...
  <Tab title="Ollama" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Configure in Pane">
        ...
        ![Ollama in Pane](/images/byollm--ollama-config.png)
      </Step>
    </Steps>
  </Tab>
  <Tab title="LM Studio" icon="desktop">
    ...
    <Steps>
      ...
      <Step title="Configure in Pane">
        ...
        ![LM Studio in Pane](/images/byollm--lmstudio-config.png)
      </Step>
    </Steps>
  </Tab>
</Tabs>
