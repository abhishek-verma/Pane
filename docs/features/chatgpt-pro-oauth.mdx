...
description: "Use your ChatGPT subscription to power Pane"
---

Connect your ChatGPT Pro or Plus subscription to Pane and access GPT-5.5, GPT-5 Codex, GPT-5.4, and the full lineup of OpenAI's most advanced models — with up to 1.05M context. No API keys needed.
