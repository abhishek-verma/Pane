...
description: "Use your GitHub Copilot subscription to power Pane"
---

Connect your GitHub Copilot subscription to Pane and access 19+ models — including Claude, GPT-5, and Gemini — through a single GitHub sign-in. No API keys needed.
...
**1.** Open Pane and go to **Settings** (`chrome://browseros/settings`). You'll see the AI Providers section.
...
**4.** Paste the device code and authorize Pane to access your Copilot subscription.
