...
description: "Connect your own AI models to Pane"
---

Pane includes a default AI model you can use right away, but it has strict rate limits. For the best experience, bring your own API keys or run models locally.
...
Already paying for ChatGPT Pro or GitHub Copilot? Connect your existing account to Pane with a single sign-in — no API keys, no extra cost.
...
{/* <img src="/images/moonshot-partnership-banner.png" alt="Pane x Moonshot AI" className="rounded-xl" /> */}

Pane has partnered with [Moonshot AI](https://www.kimi.com) to bring **Kimi K2.5** as a first-class provider. Kimi K2.5 is now the **recommended model** in Pane and is set as the default provider.

For a limited time, Pane users get **extended usage limits** powered by Kimi K2.5. This means you can use the AI agent, chat, and other AI-powered features with increased limits at no cost.
