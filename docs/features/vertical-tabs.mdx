...
Pane supports vertical tabs — a side panel that lists all your open tabs along the left edge of the browser window. Instead of shrinking tab titles into a cramped horizontal strip, vertical tabs give each tab its own full-width row so you can read titles at a glance, even with dozens of tabs open.
...
<Frame caption="Enable vertical tabs in Settings > Customization">
  <img src="/images/features--vertical-tabs-setting.png" alt="Vertical tabs toggle in Pane Customization settings" />
</Frame>
