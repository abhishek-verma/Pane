...
Pane is an AI-native browser that lets you automate any web task by describing it in plain English. Built on Chromium, it runs AI agents locally on your machine—keeping your data private while giving you superpowers for browsing.
...
<Steps>
  ...
  <Step title="Configure your AI">
    Pane includes a default AI model with limited daily usage for testing. For the full experience, bring your own API keys.
