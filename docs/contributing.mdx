---
title: "Contributing to Pane"
description: "Guide to contributing to Pane"
---

Pane has two main parts you can contribute to:
...
- [GitHub Repository](https://github.com/browseros-ai/Pane)
- [Discord Community](https://discord.gg/652JHSyS4)
- [Report Issues](https://github.com/browseros-ai/Pane/issues)

## Ways to Contribute

**Report bugs** — [Open an issue](https://github.com/browseros-ai/Pane/issues/new) with steps to reproduce, expected vs actual behavior, and screenshots.

**Suggest features** — Share ideas on [GitHub](https://github.com/browseros-ai/Pane/issues/99) or [Discord](https://discord.gg/652JHSyS4).
...
<img src="/images/contributing--architecture.png" alt="Pane Agent architecture diagram" />
...
cd Pane/packages/browseros-agent
...
Then load the extension in Pane:
...
<Tabs>
  ...
  <Tab title="macOS (x64)">
    ```bash
    <chromium-src>/out/Default_x64/Pane\ Dev.app/Contents/MacOS/Pane\ Dev \
      --enable-logging=stderr \
      --use-mock-keychain \
      --user-data-dir=/tmp/test-profile
    ```
  ...
  <Tab title="Windows">
    ```bash
    <chromium-src>\out\Default_x64\Pane Dev.exe \
      --enable-logging=stderr \
...
- **Discord** — [discord.gg/652JHSyS4](https://discord.gg/652JHSyS4)
- **GitHub Issues** — [github.com/browseros-ai/Pane/issues](https://github.com/browseros-ai/Pane/issues)
- **GitHub Discussions** — [github.com/browseros-ai/Pane/discussions](https://github.com/browseros-ai/Pane/discussions)
