...
| 17 | [Agent Tool-Call Visibility](./17-agent-tool-call-visibility.md) | Chat evidence for tool calls: file diff cards, browser action evidence, collapsed generics — refines the tool transcript in [03](./03-agent-modes-and-the-loop.md) |
| 18 | [Agent Chat Visual Language](./18-agent-chat-visual-language.md) | Calm-console design standard for the agent transcript: left-rail traces, no card stacks, composer fade — visual layer for [17](./17-agent-tool-call-visibility.md) |
| 19 | [Homescreen of the Personalised Internet](./19-homescreen-of-personal-internet.md) | Reframes [15](./15-adaptive-home.md): home as evolving front door of the private web; pulse doorways; **page-declared refresh triggers**; handoff for Personalised Internet |
| 20 | [Personalised Internet](./20-personalised-internet.md) | Private sites/pages (DSL), `pi_*` tools, refresh bus, `/pi` API, home `pi` projection — pairs with [19](./19-homescreen-of-personal-internet.md) |
| 21 | [Pane Layers](./21-pane-layers.md) | **Proposal:** persistent agent-authored website customizations; branding, current-site controls, managed/JavaScript runtime boundaries, and implementation gates — develops [16](./16-page-reshape-and-overlays.md) |
| — | [Layers Implementation Plan](./PANE-LAYERS-IMPLEMENTATION-PLAN.md) | LP-00–LP-13: file-level tasks, dependencies, capability checks, canonical skills, native/Claude Code/Codex execution, testing and release gates. |
| — | [Layers Runtime Contract](./21-pane-layers-runtime-contract.md) | Typed action results, document-bound delivery, native site controls and independent authoring verification. |
| — | [Layers Capabilities & Skills](./21-pane-layers-capabilities-and-skills.md) | Honest feasibility assessment, progressive skill loading and supported-provider parity requirements. |
...
| — | [Phase 8 Prompt](./PHASE-8-PROMPT.md) | Execution prompt for Phase 8 (evolving home: visual redesign + custom/agent widgets + proposals). For Opus-class model. |
