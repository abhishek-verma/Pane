...
4. **ICP selection**: a single question ("What do you want Pane for first? — coding / research & writing / personal automation / privacy-first") sets the path. Recalls to `USER.md` and tunes trust defaults.
