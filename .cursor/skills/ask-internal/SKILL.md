---
name: ask-internal
description: Answer questions about Pane internal stuff (setup, features, architecture, design decisions) by reading the private internal-docs submodule and the codebase. Use for "how do I X", "where is Y", "what is the deal with Z", or any question that mixes ops/setup knowledge with code knowledge. Can execute steps with per-command confirmation.
---
...
- NEVER edit Pane code or docs in response to an ask-internal question. The skill answers; it does not write files.
...
- Modify Pane code or docs from this skill.
