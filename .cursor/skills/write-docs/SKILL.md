---
name: write-docs
description: Write Pane feature documentation. Use when the user wants to create or update documentation for a Pane feature. This skill explores the codebase to understand features and writes concise Mintlify MDX docs.
---

# Write Pane Documentation

This skill helps write documentation for Pane features. It follows a structured workflow to create high-quality, concise documentation pages.
...
- **Clear**: Write for first-time Pane users
...
---
title: "Ad Blocking"
description: "Pane blocks 10x more ads than Chrome out of the box"
---

Pane ships with built-in ad blocking that works immediately—no extensions required.
...
1. Pane MCP Server
2. Connecting other MCPs to Pane assistant
3. Scheduled tasks
